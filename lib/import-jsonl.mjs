 ...
 * cut positions. The cut applies to the detail only; the tool name is never scrubbed.
 */
...
function importToolPair(db, toolUse, toolResult, project) {
  ...
  const safe = {
    ...
    // Outside scrubRecord on purpose: importedObsTitle already scrubbed it, once.
    //
